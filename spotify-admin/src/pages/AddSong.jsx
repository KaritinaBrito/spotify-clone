    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
      <div className='flex gap-8'>
        <div className='flex flex-col gap-4'>
          ...
          <label htmlFor="song">
            <img src={song ? assets.upload_added : assets.upload_song} alt="upload song" className='cursor-pointer w-24'/>
          </label>
        </div>
        <div className='flex flex-col gap-4'>
          <p>Upload image</p>
          ...
          <label htmlFor="image">
            <img src={image ? URL.createObjectURL(image) : assets.upload_area} alt="upload area" className='cursor-pointer w-24' />
          </label>
        </div>
      </div>
      ...
      <button type='submit' className='text-white bg-black py-2.5 px-14 cursor-pointer rounded-md'>Add</button>
    </form>
  )
}
